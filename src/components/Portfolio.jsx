...
import clickSound from '../assets/pop2.mp3'; // replace with the path to your sound file
  ...
  return (
    ...
    >
      <div className='relative w-full md:w-3/5'>
        <motion.div
          whileHover={{ scale: 1.1 }} // This will increase the size of the image on hover
          transition={{ duration: 0.3, ease: "easeInOut" }} // Adjust transition duration and ease
